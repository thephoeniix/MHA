...
struct Hero {
    ...
    Hero(string n, string t, string q, int p, int s, int tech, int intel, int coop)
...
void displayTree(TreeNode* root) {
    ...
    cout << "Type: " << root->type << ", Name: " << root->hero->name << std::endl;
...
public:
    ...
    void displayList(const string& attribute); //Funtion to display the Doubly Linked List
    ...
    //Function to insert a hero into the Doubly Linked List
...
//Funnction to display the Doubly Linked List 
    void DoublyLinkedList::displayList(const string& attribute) {
    Hero* current = head;

    while (current != nullptr) {
        cout << "Name: " << current->name << ", ";

        // Determine which attribute to display based on the input parameter
        if (attribute == "power") {
            cout << "Power: " << current->power;
        } else if (attribute == "speed") {
            cout << "Speed: " << current->speed;
        } else if (attribute == "technique") {
            cout << "Technique: " << current->technique;
        } else if (attribute == "intelligence") {
            cout << "Intelligence: " << current->intelligence;
        } else if (attribute == "cooperativeness") {
            cout << "Cooperativeness: " << current->cooperativeness;
        } else {
            cerr << "Invalid attribute specified." << endl;
            return;
        }
...
//Function to sort the Doubly Linked List based on different attributes
...
Hero* searchByName(TreeNode* root, const string& name) {
    if (!root) {
